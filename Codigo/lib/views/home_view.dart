...
class _HomeViewState extends State<HomeView> {
  ...
  Widget _buildInventarioCard({required String titulo, required String inicio, required String fim}) {
    return Container(
      width: 100,
      height: 80,
      ...
      child: Row(
        ...
        children: [
          const Padding(
            ...
            child: Icon(Icons.edit_calendar_rounded, color: Color(0xFF0055FF), size: 40),
          ),
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Text('Início: $inicio', style: const TextStyle(fontSize: 12)),
          ...
          IconButton( 
            ...
            onPressed: () => print('Acessar inventário'),
          ),
        ],
      ),
    );
